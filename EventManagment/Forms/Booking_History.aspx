<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Booking_History.aspx.cs" Inherits="EventManagment.Forms.Booking_History" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="row container-fluid wel-row pt-2">
            ...
            <div class="col-lg-5 col-md-5 col-sm-6 text-right logout-btn">
                <asp:Button Text="HOME" ID="AdminBooking" CssClass="btn btn-warning" runat="server" OnClick="AdminBooking_Click" />
        ...
        <div class="container book-cont text-center">
            <asp:GridView runat="server" ID="admindb" CssClass="table-striped table-dark  table-responsive-lg w-100" AutoGenerateColumns="False" DataKeyNames="BID" DataSourceID="SqlDataSource1">
                <Columns>
...
<ControlStyle CssClass="btn btn-danger"></ControlStyle>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MyConn %>" DeleteCommand="DELETE FROM [BOOKING] WHERE [BID] = @BID" InsertCommand="INSERT INTO [BOOKING] ([BNAME], [BSERNAME], [BEVENT], [BVENUE], [BDATE]) VALUES (@BNAME, @BSERNAME, @BEVENT, @BVENUE, @BDATE)" SelectCommand="SELECT [BNAME], [BSERNAME], [BEVENT], [BVENUE], [BDATE], [BID] FROM [BOOKING] ORDER BY [BDATE]" UpdateCommand="UPDATE [BOOKING] SET [BNAME] = @BNAME, [BSERNAME] = @BSERNAME, [BEVENT] = @BEVENT, [BVENUE] = @BVENUE, [BDATE] = @BDATE WHERE [BID] = @BID">
                <DeleteParameters>
                ...
                <InsertParameters>
                    ...
                    <asp:Parameter Name="BDATE" DbType="Date" />
                </InsertParameters>
                <UpdateParameters>
                    <asp:Parameter Name="BNAME" Type="String" />
                    <asp:Parameter Name="BSERNAME" Type="String" />
